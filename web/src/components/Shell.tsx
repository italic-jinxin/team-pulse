      ...
      <aside aria-label="Primary navigation">
        <div className="brand">
          ...
          <div>
            ...
            <small>Local-first GitHub Insights</small>
          </div>
        </div>
        <div className="server-card">
          ...
          <div className="server-url">http://127.0.0.1:19421</div>
        </div>
        <nav>
          {nav.map(([name, Icon]) => (
            <button
            ...
            >
              ...
              {badge(name, riskCount, openPRCount, repoCount)}
            </button>
          ))}
        </nav>
        ...
        <header>
          ...
          <div className="actions">
            ...
            >
              ...
              {refreshing ? 'Refreshing' : 'Server Status'}
            </button>
...
function badge(name: PageName, risks: number, prs: number, repos: number) {
  const value =
    name === 'Risks' ? risks : name === 'Pull Requests' ? prs : name === 'Repositories' ? repos : 0;
